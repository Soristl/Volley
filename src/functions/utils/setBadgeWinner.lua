function setBadgeWinner(badge, badgeGrayscale, playersWinner)
  local playersBadgeWinners = { "Jenji#1475", "Ramasevosaff#0000", "Rex#2654", "Raidensnd#0000", "Mulan#5042",
    ...
    "Axeldoton#0000", "Badmice9#0000", "Nagi#6356" }
...
setBadgeWinner("img@193d675bca7", "img@193d6763c82",
  { { player = "Jenji#1475", quantity = 1 }, { player = "Ramasevosaff#0000", quantity = 1 }, { player = "Rex#2654", quantity = 1 }, { player = "Raidensnd#0000", quantity = 1 }, { player = "Mulan#5042", quantity = 1 }, { player = "Basker#2338", quantity = 1 }, { player = "Axeldoton#0000", quantity = 1 }, { player = "Badmice9#0000", quantity = 1 }, { player = "Nagi#6356", quantity = 1 } })
