...
lang.br = {
  ...
  textSettings =
  "<p align='left'><font size='12px'><textformat leading='30'>Selecione o modo de jogo<br>Ativar o comando !randomball</textformat><br><br>Ativar o comando !randommap<br><br><br>Ativar o comando !twoballs</p>",
  textSettings2 =
  "<p align='left'><font size='12px'><textformat leading='30'>Selecione o tamanho do mapa (!setmap) (modo normal)<br>Ativar o comando !consumables (modo normal)</textformat><br>Ativar o modo de três bolas em três equipes",
...
lang.en = {
  ...
  textSettings =
  "<p align='left'><font size='12px'><textformat leading='30'>Select game mode<br>Activate the !randomball command</textformat><br><br>Activate the !randommap command<br><br><br>Activate the !twoballs command</p>",
  textSettings2 =
  "<p align='left'><font size='12px'><textformat leading='30'>Select the map size (!setmap) (Normal mode)<br>Activate the !consumables command (Normal mode)</textformat><br>Enable three balls on 3 teams mode",
...
lang.ar = {
  ...
  textSettings =
  "<p align='left'><font size='12px'><textformat leading='30'>اختر وضع اللعبة<br>تفعيل أمر !randomball</textformat><br><br>تفعيل أمر !randommap<br><br><br>تفعيل أمر !twoballs</p>",
  textSettings2 =
  "<p align='left'><font size='12px'><textformat leading='30'>حدد حجم الخريطة (!setmap) (الوضع العادي)<br>قم بتنشيط أمر !consumables (الوضع العادي)</textformat><br>تفعيل وضع ثلاث كرات لثلاثة فرق",
...
lang.fr = {
  ...
  textSettings =
  "<p align='left'><font size='12px'><textformat leading='30'>Sélectionner le mode de jeu<br>Activer la commande !randomball</textformat><br><br>Activer la commande !randommap<br><br><br>Activer la commande !twoballs</p>",
  textSettings2 =
  "<p align='left'><font size='12px'><textformat leading='30'>Sélectionnez la taille de la carte (!setmap) (mode normal)<br>Activez la commande !consumables (mode normal)</textformat><br>Activez le mode à trois balles pour trois équipes.",
...
lang.pl = {
  ...
  textSettings =
  "<p align='left'><font size='12px'><textformat leading='30'>Wybierz tryb gry<br>Aktywuj polecenie !randomball</textformat><br><br>Aktywuj polecenie !randommap<br><br><br>Aktywuj polecenie !twoballs</p>",
  textSettings2 =
  "<p align='left'><font size='12px'><textformat leading='30'>Wybierz rozmiar mapy (!setmap) (tryb normalny)<br>Aktywuj polecenie !consumables (tryb normalny)</textformat><br>Aktywuj tryb gry z trzema piłkami dla trzech drużyn.",
