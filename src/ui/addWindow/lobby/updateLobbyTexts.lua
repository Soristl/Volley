function updateLobbyTexts(name)
  ...
  for i = 1, 3 do
    ...
    if playersBlue[i].name == name then
      playersBlue[i].name = ''
      ui.addTextArea(i + 3, "<p align='center'><font size='14px'><a href='event:joinTeamBlue" .. (i + 3) .. "'>Join", nil,
  ...
  for i = 8, 10 do
    if playersYellow[i - 7].name == name then
      ...
      ui.addTextArea(i, "<p align='center'><font size='14px'><a href='event:joinTeamYellow" .. (i - 7) .. "'>Join", nil,
  ...
  for i = 11, 13 do
    if playersGreen[i - 10].name == name then
      ...
      ui.addTextArea(i, "<p align='center'><font size='14px'><a href='event:joinTeamGreen" .. (i - 10) .. "'>Join", nil,
