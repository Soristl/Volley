...
local globalSettings = { mode = 'Normal mode', twoBalls = false, randomBall = false, randomMap = false, mapType = '', consumables = false, threeBalls = false, minimalist = true, minimalistToggleMap = true }
local settings = {}
local settingsMode = {}
